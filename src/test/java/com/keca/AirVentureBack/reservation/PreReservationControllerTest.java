...
public class PreReservationControllerTest {
    ...
    public void testGetFinalReservations() throws Exception {
        mockMvc
                .perform(MockMvcRequestBuilders.get("/preReservations")
    ...
    public void testGetOneFinalReservation() throws Exception {
        mockMvc
                .perform(MockMvcRequestBuilders.get("/preReservation/1")
                        .cookie(new Cookie("token", getAuthenticationCookie()))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.expirationDate").value("2024-11-19T23:00:00.000+00:00"))
